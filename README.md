...
The repository contains two CSV files that contain the [original County Health data](/datasets/CountyHealthData_2014-2015.csv) and its [coinciding NC subset](/datasets/NC_subset.csv). These datasets are contained in the folder above, and right below them is the [Markdown directory](/MarkdownDirectory.ipynb) that contains the actual instructions on creating the new subset.
